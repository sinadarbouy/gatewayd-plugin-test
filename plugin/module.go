...
var (
	PluginID = v1.PluginID{
		...
		Version:   "0.0.1",
		RemoteUrl: "https://github.com/sinadarbouy/gatewayd-plugin-test",
	}
	PluginMap = map[string]goplugin.Plugin{
		"gatewayd-plugin-test": &GatewaydPluginTest{},
	}
	// TODO: Handle this in a better way
	// https://github.com/gatewayd-io/gatewayd-plugin-sdk/issues/3
	PluginConfig = map[string]interface{}{
		"id": map[string]interface{}{
			"gatewayd-plugin-test": PluginID.GetName(),
			"version":    PluginID.GetVersion(),
			"remoteUrl":  PluginID.GetRemoteUrl(),
		},
		"description": "Template plugin",
		"authors": []interface{}{
			"sinadarbouy <sinadarbouy@gmail.com>",
		},
		"license":    "Apache 2.0",
		"projectUrl": "https://github.com/sinadarbouy/gatewayd-plugin-test",
		// Compile-time configuration
		"config": map[string]interface{}{
			"metricsEnabled": sdkConfig.GetEnv("METRICS_ENABLED", "true"),
			"metricsUnixDomainSocket": sdkConfig.GetEnv(
				"METRICS_UNIX_DOMAIN_SOCKET", "/tmp/gatewayd-plugin-test.sock"),
