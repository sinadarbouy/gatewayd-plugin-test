...
type GatewaydPluginTest struct {
	goplugin.NetRPCUnsupportedPlugin
	Impl Plugin
}

// GRPCServer registers the plugin with the gRPC server.
func (p *GatewaydPluginTest) GRPCServer(b *goplugin.GRPCBroker, s *grpc.Server) error {
	v1.RegisterGatewayDPluginServiceServer(s, &p.Impl)
	return nil
}

// GRPCClient returns the plugin client.
func (p *GatewaydPluginTest) GRPCClient(ctx context.Context, b *goplugin.GRPCBroker, c *grpc.ClientConn) (interface{}, error) {
	return v1.NewGatewayDPluginServiceClient(c), nil
}

// NewGatewaydPluginTest returns a new instance of the TestPlugin.
func NewGatewaydPluginTest(impl Plugin) *GatewaydPluginTest {
	return &GatewaydPluginTest{
...
func (p *Plugin) OnNewPool(ctx context.Context, req *v1.Struct) (*v1.Struct, error) {
	OnNewPool.Inc()
	// Example req:
	// {"gatewayd-plugin-test":"default","size":10}
